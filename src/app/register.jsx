...
export default function RegisterScreen() {
  ...
  const handleSave = () => {
    ...
    Alert.alert("Registered!", "Your information has been registered successfully.");
  };
        ...
        <View style={styles.form}>
          ...
          <View style={styles.passwordContainer}>
            ...
            <Pressable style={styles.eyeButton} onPress={() => setShowConfirmPassword(!showConfirmPassword)} hitSlop={10}>
              {showConfirmPassword ? <Eye color="white" size={20} /> : <EyeOff color="white" size={20} />}
            </Pressable>
          </View>
          ...
          <TouchableOpacity style={styles.switchBtn} onPress={() => router.push("/")}>
            <Text style={styles.switchText}>
              Already have an account? <Text style={styles.linkText}>Log In</Text>
            </Text>
          </TouchableOpacity>

          <TouchableOpacity style={styles.switchBtn} onPress={() => router.push("/driver/register")}>
            <Text style={styles.switchText}>
...
const styles = StyleSheet.create({
  ...
  eyeButton: { paddingHorizontal: 10, justifyContent: "center", alignItems: "center" },
